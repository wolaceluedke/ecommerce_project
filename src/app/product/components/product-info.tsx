...
const ProductInfo = (
    {product: {name, basePrice, totalPrice, description, discountPercentage}}: ProductInfoProps) => {
    ...
    return ( 
        ...
        <Button className="mt-8 uppercase font-bold">Adicionar no Carrinho</Button>
